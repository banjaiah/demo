package com.ctl.techXpert.seleniumrepository;
...
public class AppiumRepo {
	...
	public static WebDriver startAppium(String platformName)throws MalformedURLException {
		...
		if (platformName.equalsIgnoreCase("Android")) {
			...
			cap.setCapability("udid", "620853c8");
			cap.setCapability("deviceName", "Samsung Galaxy7");
			cap.setCapability("appPackage", "com.ctl.max2");
			cap.setCapability("appActivity", "com.ctl.max2.LoginActivity");
