...
import com.ctl.techXpert.dataprovider.ExcelDataProviderObject;
import com.ctl.techXpert.projectpage.TestngAnnotations;
import com.ctl.techXpert.seleniumrepository.SeleniumRepo;
import com.ctl.techXpert.seleniumrepository.SeleniumRepoDropdown;
import com.ctl.techXpert.util.PropertyFileRead;

public class TC002MapSearchPage extends TestngAnnotations {

	@Test(dataProviderClass = com.ctl.techXpert.dataprovider.ExcelDataProvider.class,dataProvider="getGoogleMapsData")
	...
	@Test(dataProviderClass = com.ctl.techXpert.dataprovider.ExcelDataProvider.class,dataProvider="getData")
